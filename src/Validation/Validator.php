...
use Volcano\Validation\PresenceVerifierInterface;
...
class Validator implements MessageProviderInterface
{
     ...
     *
     * @var \Volcano\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \Volcano\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \Volcano\Config\Repository  $config
     * @param  array  $data
     * @param  array  $rules
     ...
     *
     * @return \Volcano\Validation\Contracts\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Volcano\Validation\Contracts\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
