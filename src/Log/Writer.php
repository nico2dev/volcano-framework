...
use Volcano\Events\DispatcherInterface as EventsDispatcher;

use Volcano\Contracts\JsonableInterface as Jsonable;
...
class Writer implements PsrLoggerInterface
{
     ...
     *
     * @var \Volcano\Events\DispatcherInterface
     */
    protected $events;
     ...
     * @param  \Volcano\Events\DispatcherInterface  $dispatcher
     * @return void
     */
     ...
     */
    public function useSyslog($name = 'Volcano', $level = 'debug')
    {
     ...
     *
     * @return \Volcano\Events\DispatcherInterface
     */
     ...
     *
     * @param  \Volcano\Events\DispatcherInterface  $events
     * @return void
     */
