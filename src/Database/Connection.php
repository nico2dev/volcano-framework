...
use Volcano\Database\Query\Processors\Processor;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Volcano\Database\Query\Grammars\Grammar
     */
     ...
     *
     * @var \Volcano\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Volcano\Database\Query\Grammars\Grammar
     */
     ...
     *
     * @return \Volcano\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @return \Volcano\Database\Schema\Builder
     */
     ...
     *
     * @param  \Volcano\Database\QueryException  $e
     * @param  string    $query
     * @param  array     $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     *
     * @param  \Volcano\Database\QueryException
     * @return bool
     */
    ...
    public function logQuery($query, $bindings, $time = null)
    {
        if (isset($this->events)) {
            $this->events->dispatch('Volcano.query', array($query, $bindings, $time, $this->getName()));
        }
    ...
    {
        if (isset($this->events)) {
            $this->events->listen('Volcano.query', $callback);
        }
    }
     ...
     *
     * @param  \Volcano\Database\Query\Grammars\Grammar
     * @return void
     */
     ...
     *
     * @param  \Volcano\Database\Schema\Grammars\Grammar
     * @return void
     */
     ...
     *
     * @param  \Volcano\Database\Query\Processors\Processor
     * @return void
     */
     ...
     *
     * @param  \Volcano\Events\Dispatcher
     * @return void
     */
     ...
     *
     * @param  \Volcano\Cache\CacheManager|\Closure  $cache
     * @return void
     */
     ...
     *
     * @param  \Volcano\Database\Grammar  $grammar
