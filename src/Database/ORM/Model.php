...
use Volcano\Database\ORM\Relations\Pivot;
use Volcano\Database\ORM\Relations\HasOne;
use Volcano\Database\ORM\Relations\HasMany;
use Volcano\Database\ORM\Relations\MorphTo;
use Volcano\Database\ORM\Relations\Relation;
use Volcano\Database\ORM\Relations\MorphOne;
use Volcano\Database\ORM\Relations\MorphMany;
use Volcano\Database\ORM\Relations\BelongsTo;
use Volcano\Database\ORM\Relations\MorphToMany;
use Volcano\Database\ORM\Relations\BelongsToMany;
use Volcano\Database\ORM\Relations\HasOneThrough;
use Volcano\Database\ORM\Relations\BelongsToThrough;
use Volcano\Database\ORM\Relations\HasManyThrough;
use Volcano\Database\Query\Builder as QueryBuilder;
use Volcano\Database\ConnectionResolverInterface as Resolver;
use Volcano\Queue\QueueableEntityInterface as QueueableEntity;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity
{
     ...
     *
     * @param  \Volcano\Database\ORM\ScopeInterface  $scope
     * @return void
     */
     ...
     *
     * @param  \Volcano\Database\ORM\ScopeInterface  $scope
     * @return \Volcano\Database\ORM\ScopeInterface|null
     */
     ...
     *
     * @return \Volcano\Database\ORM\ScopeInterface[]
     */
     ...
     *
     * @param  array  $columns
     * @return \Volcano\Database\ORM\Collection|static[]
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Volcano\Support\Collection|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Volcano\Support\Collection|static
     */
     ...
     *
     * @param  array|string  $relations
     * @return \Volcano\Database\ORM\Builder|static
     */
     ...
     * @return \Volcano\Database\ORM\Relations\HasOne
     */
     ...
     * @return \Volcano\Database\ORM\Relations\HasOneThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Volcano\Database\ORM\Relations\MorphOne
     */
     ...
     * @return \Volcano\Database\ORM\Relations\BelongsTo
     */
     ...
     * @param  string|null  $secondKey
     * @param  string|null  $localKey
     * @return \Volcano\Database\ORM\Relations\BelongsToThrough
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \Volcano\Database\ORM\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Volcano\Database\ORM\Relations\HasMany
     */
     ...
     * @param  string|null  $firstKey
     * @param  string|null  $secondKey
     * @return \Volcano\Database\ORM\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Volcano\Database\ORM\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool    $inverse
     * @return \Volcano\Database\ORM\Relations\MorphToMany
     */
    ...
    public static function flushEventListeners()
    {
        ...
        foreach ($instance->getObservableEvents() as $event) {
            static::$dispatcher->forget("Volcano.database.orm.{$event}: ".get_called_class());
        }
    }
    ...
    protected static function registerModelEvent($event, $callback)
    {
        if (isset(static::$dispatcher)) {
            ...
            static::$dispatcher->listen("Volcano.database.orm.{$event}: {$name}", $callback);
        }
    }
    ...
    protected function fireModelEvent($event, $halt = true)
    {
        ...
        //
        $event = "Volcano.database.orm.{$event}: ".get_class($this);
    ...
    protected function getRelationshipFromMethod($key, $camelKey)
    {
        ...
        if (! $relation instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type [Volcano\Database\ORM\Relations\Relation]');
        }
     ...
     *
     * @return \Volcano\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \Volcano\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @param  \Volcano\Events\Dispatcher  $dispatcher
     * @return void
     */
