...
class Builder
{
     ...
     *
     * @var \Volcano\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Volcano\Database\ORM\Model|static|null
     */
     ...
     * @param  array  $ids
     * @param  array  $columns
     * @return \Volcano\Database\ORM\Model|Collection|static
     */
     ...
     * @return \Volcano\Database\ORM\Model|static|mixed
     */
     ...
     * @return \Volcano\Database\ORM\Relations\Relation
     */
     ...
     *
     * @param  \Volcano\Database\ORM\Builder  $hasQuery
     * @param  \Volcano\Database\ORM\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
