...
use Volcano\Broadcasting\Auth\Guest as GuestUser;
use Volcano\Broadcasting\BroadcasterInterface;
use Volcano\Broadcasting\Channel;
...
abstract class Broadcaster implements BroadcasterInterface
{
     ...
     *
     * @var \Volcano\Broadcasting\Auth\Guest|null
     */
    protected $authGuest;
     ...
     *
     * @return \Volcano\Broadcasting\Auth\Guest
     */
