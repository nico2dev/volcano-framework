...
use Volcano\Broadcasting\Broadcasters\LogBroadcaster;
use Volcano\Broadcasting\Broadcasters\NullBroadcaster;
use Volcano\Broadcasting\Broadcasters\RedisBroadcaster;
use Volcano\Broadcasting\Broadcasters\PusherBroadcaster;
use Volcano\Broadcasting\Broadcasters\QuasarBroadcaster;
use Volcano\Broadcasting\FactoryInterface;
use Volcano\Broadcasting\PendingBroadcast;
...
class BroadcastManager implements FactoryInterface
{
     ...
     *
     * @param  \Volcano\Http\Request|null  $request
     * @return string|null
     */
     ...
     * @return \Volcano\Broadcasting\PendingBroadcast|void
     */
     ...
     *
     * @param  string  $name
     * @return \Volcano\Broadcasting\BroadcasterInterface
     *
