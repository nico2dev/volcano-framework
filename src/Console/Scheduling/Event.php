...
class Event
{
     ...
     *
     * @var \Volcano\Console\Scheduling\MutexInterface
     */
    public $mutex;
     ...
     *
     * @param  \Volcano\Contracts\Mail\Mailer  $mailer
    ...
    protected function getEmailSubject()
    {
        if (isset($this->description)) {
            return __d('volcano', 'Scheduled Job Output ({0})', $this->description);
        }

        return __d('volcano', 'Scheduled Job Output');
    }
