...
use Volcano\Auth\DatabaseUserProvider;
use Volcano\Auth\ExtendedUserProvider;
use Volcano\Auth\RequestGuard;
use Volcano\Auth\SessionGuard;
use Volcano\Auth\TokenGuard;
...
class AuthManager
{
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \Volcano\Auth\TokenGuard
     */
     ...
     * @return \Volcano\Auth\UserProviderInterface
     *
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @return \Volcano\Auth\DatabaseUserProvider
     */
     ...
     *
     * @return \Volcano\Auth\ExtendedUserProvider
     */
