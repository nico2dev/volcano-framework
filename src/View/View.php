...
use Volcano\Contracts\RenderableInterface as Renderable;
use Volcano\Contracts\MessageProviderInterface as MessageProvider;

use Volcano\Support\MessageBag;
use Volcano\Support\Arr;
use Volcano\Support\Str;

use Volcano\View\Engines\EngineInterface;
...
class View implements ArrayAccess, Renderable
{
     ...
     *
     * @var \Volcano\View\Engines\EngineInterface
     */
    protected $engine;
     ...
     * @param  string  $method
     * @param  array   $params
     * @return \Volcano\View\View|static|void
     *
