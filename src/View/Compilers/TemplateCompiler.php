...
use Volcano\View\Compilers\Compiler;
...
class TemplateCompiler extends Compiler implements CompilerInterface
{
    ...
    {
        return "<?php if (app('Volcano\\Auth\\Access\\GateInterface')->check{$expression}): ?>";
    }
    ...
    {
        return "<?php if (app('Volcano\\Auth\\Access\\GateInterface')->denies{$expression}): ?>";
    }
