...
namespace Volcano\Foundation\Http;
...
use Volcano\Validation\ValidatesWhenResolvedInterface as ValidatesWhenResolved;
use Volcano\Validation\ValidatesWhenResolvedTrait;

use Volcano\Contracts\Validation\Factory as ValidationFactory;
