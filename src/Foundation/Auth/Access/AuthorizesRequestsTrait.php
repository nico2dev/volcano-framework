...
use Volcano\Auth\Access\GateInterface;
...
trait AuthorizesRequestsTrait
{
    ...
    public function authorize($ability, $arguments = array())
    {
        ...
        $gate = App::make('Volcano\Auth\Access\GateInterface');
     ...
     *
     * @param  \Volcano\Auth\UserInterface|mixed  $user
     * @param  mixed  $ability
     * @param  mixed|array  $arguments
     * @return \Volcano\Auth\Access\Response
     *
    ...
    public function authorizeForUser($user, $ability, $arguments = array())
    {
        ...
        $gate = App::make('Volcano\Auth\Access\GateInterface')->forUser($user);
