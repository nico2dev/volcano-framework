...
namespace Volcano\Localization;
...
class MessageFormatter
{
    ...
    /**
     * Formate un message via [ICU message format](http://userguide.icu-project.org/formatparse/messages)
     *
     * Si PHP INTL n'est pas installé, une solution de secours prenant en charge un sous-ensemble 
     * du format de message ICU sera utilisée.
     *
    ...
    /**
     * Implémentation de secours pour MessageFormatter :: formatMessage
     *
     * @param string $pattern
    ...
    /**
     * Tokénise un motif en séparant le texte normal des motifs remplaçables
     *
     * @param string $pattern
     * @return array
     * @throws \LogicException
